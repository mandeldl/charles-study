...
class CaseStudiesControllerTest < ActionController::TestCase
  ...
  test "should create case_study" do
    assert_difference('CaseStudy.count') do
      post :create, case_study: { description: @case_study.description, github: @case_study.github, title: @case_study.title, updates: @case_study.updates, url: @case_study.url }
    end
  ...
  test "should update case_study" do
    patch :update, id: @case_study, case_study: { description: @case_study.description, github: @case_study.github, title: @case_study.title, updates: @case_study.updates, url: @case_study.url }
    assert_redirected_to case_study_path(assigns(:case_study))
  end
